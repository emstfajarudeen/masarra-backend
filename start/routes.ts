...
router
  .group(() => {
    ...
    router.get('/subscriptions', [AdminPanelController, 'subscriptions'])
    router.get('/subscriptions/create', [AdminPanelController, 'subscriptionCreate'])
    router.post('/subscriptions', [AdminPanelController, 'subscriptionStore'])
    router.get('/subscriptions/:id/edit', [AdminPanelController, 'subscriptionEdit'])
    router.put('/subscriptions/:id', [AdminPanelController, 'subscriptionUpdate'])
    router.patch('/subscriptions/:id/status', [AdminPanelController, 'subscriptionUpdateStatus'])
    router.delete('/subscriptions/:id', [AdminPanelController, 'subscriptionDestroy'])
    router.get('/subscriptions/:id', [AdminPanelController, 'subscriptionShow'])
    ...
    router.get('/fun-rules', [AdminPanelController, 'funRules'])
    router.get('/fun-rules/create', [AdminPanelController, 'funRuleCreate'])
    router.post('/fun-rules', [AdminPanelController, 'funRuleStore'])
    router.get('/fun-rules/:id/edit', [AdminPanelController, 'funRuleEdit'])
    router.put('/fun-rules/:id', [AdminPanelController, 'funRuleUpdate'])
    router.patch('/fun-rules/:id/status', [AdminPanelController, 'funRuleUpdateStatus'])
