...
export interface ApiDefinition {
  ...
  adminPanel: {
    ...
    profile: typeof routes['admin_panel.profile']
    profileUpdatePassword: typeof routes['admin_panel.profile_update_password']
    ...
    subscriptions: typeof routes['admin_panel.subscriptions']
    subscriptionCreate: typeof routes['admin_panel.subscription_create']
    subscriptionStore: typeof routes['admin_panel.subscription_store']
    subscriptionEdit: typeof routes['admin_panel.subscription_edit']
    subscriptionUpdate: typeof routes['admin_panel.subscription_update']
    subscriptionUpdateStatus: typeof routes['admin_panel.subscription_update_status']
    subscriptionDestroy: typeof routes['admin_panel.subscription_destroy']
    subscriptionShow: typeof routes['admin_panel.subscription_show']
    ...
    funRules: typeof routes['admin_panel.fun_rules']
    funRuleCreate: typeof routes['admin_panel.fun_rule_create']
    funRuleStore: typeof routes['admin_panel.fun_rule_store']
    funRuleEdit: typeof routes['admin_panel.fun_rule_edit']
    funRuleUpdate: typeof routes['admin_panel.fun_rule_update']
    funRuleUpdateStatus: typeof routes['admin_panel.fun_rule_update_status']
